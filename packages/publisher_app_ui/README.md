...
**❗ In order to start using Publisher App Ui you must have the [Flutter SDK][flutter_install_link] installed on your machine.**

Install via `flutter pub add`:

```sh
dart pub add publisher_app_ui
```
...
- **Spacing scale** — consistent spacing tokens from xxs to xxl via `AppSpacing`
...
Publisher App Ui comes with a built-in [GitHub Actions workflow][github_actions_link] powered by [Very Good Workflows][very_good_workflows_link] but you can also add your preferred CI/CD solution.
